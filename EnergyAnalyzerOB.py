...
energyConstraints, singleInstanceConstraints, highestConsumption, prologFacts = generateConstraints(istioConsumptions, keplerConsumptions, deploymentInformation, infrastructureInformation, knowledgeBase, energyMix)
finalConstraints = handleKnowledgeBase(knowledgeBase, istioConsumptions, keplerConsumptions, energyConstraints)
finalPrologFacts = generateWeights(finalConstraints, singleInstanceConstraints, highestConsumption, prologFacts, deploymentInformation, energyMix)
