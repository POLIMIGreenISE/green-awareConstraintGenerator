...
highConsumptionService(frontend,large,germany,0.3940298507462686).
highConsumptionService(frontend,large,spain,0.2626865671641791).
...
highConsumptionService(productcatalogservice,large,greatbritain,0.28381592437287634).
highConsumptionService(productcatalogservice,large,italy,0.4463771580512375).
